...
def stim_config(ifi):
    ...
    stim = {}
    stim['nreps'] = 2 # number of gratings per sequence
    stim['nstim'] = 6 # number of gratings per sequence
    stim['nstimloc'] = 6 # number of gratings per sequence
    ...
    stim['ISI3_frames'] = round(500/ifi) # fixation  + circle + resp_options
    ...
    # Stimuli parameters
    stim['size_stim'] = 11 # degs # este es el lado del cuadrado del grating
